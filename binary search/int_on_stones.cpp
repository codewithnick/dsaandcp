...
ll fast_exponentiation(ll base, ll pow) {
    ll result; // variable to store intermediaries
    ...
    // odd power
        ...
        return (result * base * result)%1000000007;
    }
}
void solve() {
    ll a,n;
    ...
    cout<<fast_exponentiation(a,n/2)<<endl;
}
